...
<script>
    layui.use(['jquery', 'layer', 'miniAdmin'], function () {
        window.$ = layui.jquery, layer = layui.layer, miniAdmin = layui.miniAdmin;
        miniAdmin.render({
            iniUrl: APP_BASE + "/_init.json", clearUrl: APP_BASE + "/_clear.json",
            urlHashLocation: true, bgColorDefault: false, multiModule: false, menuChildOpen: false, loadingTime: 0, pageAnim: false, maxTabNum: 20,
            isParent: true, //首页增加这个即可
        });
    });
</script>
</html>